...
func New() *Core8080 {
    c := &Core8080{
        ...
        Flags: 0x00, Irq: false, Write: false, Sync: false,
        cycles: 0,
    }
...
func (core *Core8080) RunTick(mem *memory.MainMemory) {
...
func (core *Core8080) ExecuteOpcode(opcode []uint8, mem *memory.MainMemory) {
    switch opcode[0] {
    case 0x00: 	   //NOP	1		
        fmt.Printf("NOP\n")
        core.PC++
